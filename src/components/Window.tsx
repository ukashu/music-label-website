...
export default function Window(props: Props) {
  return (
    <div
      className="absolute bottom-0 left-0 right-0 top-0 m-auto flex h-[200px] w-[200px] flex-col border-b-2 border-l-4 border-r-2 border-t-4 border-b-zinc-500 border-l-zinc-200 border-r-zinc-500 border-t-zinc-200"
      id="window"
      ...
      <main className="flex-grow bg-zinc-950">CONTENT</main>
    </div>
  )
}
